...
class FileProcess {
    ...
    final static String STORELIST = "StoreList.txt";
    ...
    private void initSDCard() {
        ...
        File newdir = new File(sdroot.getPath(), "Storepad");
    ...
    ArrayList<String> getStoreList() {
        ...
        try {
            if (bSDCard) {
                File listfile = new File(sdfolder, STORELIST);
                fis = new FileInputStream(listfile);
            } else {
                fis = mCtx.openFileInput(STORELIST);
            }
            String str;
            do {
                str = readOneLine(fis);
    ...
    void addStore(String title, String body, boolean isNew) {
        ...
        try {
            if (bSDCard) {
                File f = new File(sdfolder, STORELIST);
                fos = new FileOutputStream(f, true);
            } else {
                fos = mCtx.openFileOutput(STORELIST,
                        Context.MODE_APPEND);
            }
    ...
    void delStore(int i) {
        ...
        ArrayList<String> notelist = getStoreList();
